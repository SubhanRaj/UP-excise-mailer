    ...
    <div class="max-w-2xl bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
        <form method="POST" action="{{ route('admin.mail-accounts.store') }}" class="space-y-5">
            ...
            <div class="border-t border-slate-200 dark:border-slate-700 pt-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <input type="text" id="imap_host" name="imap_host" value="{{ old('imap_host') }}" placeholder="imap.gmail.com" class="field-input @error('imap_host') field-error @enderror">
                        @error('imap_host')<p class="field-err-msg">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <input type="number" id="imap_port" name="imap_port" value="{{ old('imap_port', 993) }}" placeholder="993" class="field-input @error('imap_port') field-error @enderror">
