            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-slate-600 dark:text-slate-300">{{ $zone->jc_name ?? '—' }}</td>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-slate-600 dark:text-slate-300">{{ $division->dc_name ?? '—' }}</td>
            ...
            <table class="w-full text-sm">
                <thead class="bg-slate-50 dark:bg-slate-900/50 text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                    <tr>
                        ...
                        <th class="text-left px-4 py-3">Division</th>
                        <th class="text-left px-4 py-3">Zone</th>
                        <th class="text-left px-4 py-3">AEC (DEO) Name</th>
                        <th class="text-left px-4 py-3">AEC (DEO) Email</th>
                        <th class="text-left px-4 py-3">AEC (DEO) CUG</th>
                        @if(auth()->user()->isAdmin())<th class="text-right px-4 py-3">Actions</th>@endif
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-slate-600 dark:text-slate-300">{{ $district->deo_name ?? '—' }}</td>
