<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>@yield('title', 'UP Excise Mailer')</title></head>
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;border:1px solid #e2e8f0;max-width:560px;width:100%;overflow:hidden;">
        <tr>
          <td style="background:#4f46e5;padding:24px 32px;">
            ...
            <p style="margin:4px 0 0;font-size:18px;font-weight:600;color:#fff;">Department of Excise — Mailer</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:20px 32px;border-top:1px solid #e2e8f0;background:#f8fafc;">
            <p style="margin:0;font-size:12px;color:#94a3b8;">UP Excise Mailer &middot; Department of Excise, Government of Uttar Pradesh</p>
