@props(['icon', 'heading', 'message', 'title' => null, 'primaryLabel' => 'Go to Dashboard', 'primaryRoute' => 'dashboard', 'primaryIcon' => 'ti-home'])

<!DOCTYPE html>
<html lang="en" class="h-full">

<x-head :title="$title ?? $heading" :description="$message" />
